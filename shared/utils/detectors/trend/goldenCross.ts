...
export class GoldenCrossDetector extends TrendPatternDetector {
  protected override readonly id = PatternIdEnum.GoldenCross;
  protected override readonly direction = PatternDirectionEnum.Bullish;
  protected override readonly baseConfidence = EXTRA_CONFIDENCE.goldenCross;
