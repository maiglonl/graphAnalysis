...
export class PiercingLineDetector extends CandlePatternDetector {
  readonly id = PatternIdEnum.PiercingLine;
  readonly direction = PatternDirectionEnum.Bullish;
  readonly baseConfidence = EXTRA_CONFIDENCE.piercingLine;
