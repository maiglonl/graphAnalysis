...
export class MacdBullishCrossDetector extends MomentumPatternDetector {
  detect(ctx: ScanContext) {
    ...
    return this.buildSignal(ctx, PatternIdEnum.MacdBullishCross, PatternDirectionEnum.Bullish, EXTRA_CONFIDENCE.macdBullishCross);
  }
}
